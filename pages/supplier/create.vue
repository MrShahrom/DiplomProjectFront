<template>
    <h2 class="text-center mt-5 mb-3">Добавление поставщика</h2>
    <div class="card">
      <div class="card-header">
        <NuxtLink class="btn btn-outline-info float-right" to="/supplier">Просмотр всех поставщиков</NuxtLink>
      </div>
      <div class="card-body">
        <form>
...
import { createSuppliers } from '~/services/projectService';
...
export default {
  ...
  methods: {
    ...
    handleSave() {
      ...
      createSuppliers(this.project, headers)
        .then(response => {
          Swal.fire({
            icon: 'success',
